...
export const partnerNetwork = [
  ...
  },
  {
    ...
    body: "The stack the work runs on, and whether it is earning its place.",
    who: "Systems people who have chosen, bought and lived with production technology. They can tell you what the stack is costing in licences and in workarounds, and what would actually change if you replaced it.",
  },
  {
    no: "04",
    discipline: "AI",
  ...
  },
  {
    no: "11",
    discipline: "Legal",
    body: "Rights, contracts and the terms the work is actually made under.",
    who: "Rights and contract specialists from inside production, not general counsel borrowed from elsewhere. Buyouts, usage, talent terms, IP. They read the deal the way it will be argued about in two years.",
  },
  {
    no: "12",
    discipline: "Sustainability",
    body: "Producing to a real standard, and being able to show it.",
    who: "People who have cut the footprint of a shoot without cutting the film. Measurement, certification, and the difference between a production that is greener and a production that says so.",
  },
] as const;
